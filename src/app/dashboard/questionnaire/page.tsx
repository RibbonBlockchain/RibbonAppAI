...
export default function Questionnaire() {
  return (
    <div className="pt-7 px-5">
      ...
      <div className="mt-10 w-full bg-gradient-to-r from-[#714EE7] to-[#A81DA6] text-white text-center py-3.5 font-semibold rounded-lg fixed bottom-4 left-0 right-0 mx-5">
        <Link href="/dashboard/questionnaire/verify-phone-number" className="">
          Start Questionnaire
        </Link>
      </div>
    </div>
